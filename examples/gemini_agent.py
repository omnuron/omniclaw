...
# Mocking library if not installed for the example to be runnable sans-deps
try:
...
async def run_agent_loop(user_prompt: str):
    ...
    if "pay" in user_prompt.lower() and "coffee" in user_prompt.lower():
        ...
        print("🤖 Gemini: I can help you buy things on Arc with USDC. Try asking me to buy a coffee.")
